    ...
    return (
        <motion.div
            ...
            className={`
                ...
                ${highlight ? 'font-black text-[7vw] md:text-[6vw] leading-[0.9] text-white' : 'font-bold text-[3.5vw] md:text-[2.5vw] text-neutral-500'}
                font-display uppercase tracking-tighter whitespace-nowrap z-0
            `}
        >
            {redCap ? (
                <>
                    <span className="text-red-500 inline-block">{redCap}</span>{text}
                </>
            ) : (
                text
            )}
